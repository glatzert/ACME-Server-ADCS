...
public sealed class TlsAlpn01ChallengeValidator(ILogger<TlsAlpn01ChallengeValidator> logger) : ChallengeValidator(logger)
{
    ...
    protected override async Task<ChallengeValidationResult> ValidateChallengeInternalAsync(Challenge challenge, Account account, CancellationToken cancellationToken)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.Connection(challenge.Authorization.Identifier, ex.Message));
        }

        if (remoteCertificate == null)
        {
            _logger.LogInformation("The remote server did not present a certificate.");
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server did not present a certificate."));
        }
        ...
        if (subjectAlternateNameExtensions.Count != 1)
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented an invalid number of Subject Alternative Name (SAN) extensions."));
        }
        ...
        if (dnsNames.Count != 1)
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented an invalid number of DNS names in the Subject Alternative Name (SAN) extension."));
        }
        ...
        if (dnsNames[0] != connectionHost)
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented an invalid DNS name in the Subject Alternative Name (SAN) extension."));
        }
        ...
        if(acmeIdentifierExtensions.Count != 1)
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented an invalid number of id-pe-acmeIdentifier extensions."));
        }
        ...
        if (!acmeIdentifierExtension.Critical) {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented a non-critical id-pe-acmeIdentifier extension."));
        }
        ...
        if (!presentedChallengeResponse.SequenceEqual(expectedChallengeResponse))
        {
            ...
            return new(ChallengeResult.Invalid, AcmeErrors.IncorrectResponse(challenge.Authorization.Identifier, "The server presented an invalid id-pe-acmeIdentifier extension."));
        }
