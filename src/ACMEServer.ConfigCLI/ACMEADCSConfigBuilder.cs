...
{
    protected override string? ScreenTitle => throw new NotImplementedException();

    protected override string? ScreenDescription => throw new NotImplementedException();

    protected override List<CLIAction> Actions => throw new NotImplementedException();
