...
namespace ACMEServer.Storage.FileSystem
{
    public class CertificateStore : StoreBase, ICertificateStore
    {
        ...
        public async Task<OrderCertificates?> LoadCertificateAsync(CertificateId certificateId, CancellationToken cancellationToken)
        {
            ...
            var certificates = await LoadFromPath<OrderCertificates>(certificateFilePath, cancellationToken);
            return certificates;
        }

        public async Task SaveCertificateAsync(OrderCertificates certificates, CancellationToken cancellationToken)
        {
            ...
            var existingCertificates = await LoadFromStream<OrderCertificates>(fileStream, cancellationToken);
