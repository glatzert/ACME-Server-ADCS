...
Both servers should be part of the same Windows Domain.
If you want to, ACME-ADCS can also be run on the ADCS itself and does not need a dedicated server.
